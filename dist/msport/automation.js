...
exports.MsportAutomation = void 0;
const playwright_1 = require("playwright");
// ---- Msport Automation ----
class MsportAutomation {
    session = null;
    config;
    reconnectAttempts = 0;
    constructor(config) {
    ...
    async handleCloudflare(page) {
        ...
        if (await cfChallenge.isVisible({ timeout: 3_000 }).catch(() => false)) {
            ...
            await page.waitForFunction(() => {
                const challenge = document.querySelector('#challenge-running, .cf-browser-verification');
     ...
     */
    async selectSafeMarket(page, pick) {
        try {
...
exports.MsportAutomation = MsportAutomation;
// ---- Helper Functions ----
